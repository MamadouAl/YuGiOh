...
select * from P12_edition where nom_edition REGEXP '^Bataille';
...
-- 2EME REQUETE
    -- a.1 Cartes Magie de l'edition 1
    SELECT carte_nom, carte_image
    FROM P12_carte NATURAL JOIN P12_carteEdition
        WHERE num_edition = 1 AND carte_categorie ='Magie';
    ...
    SELECT carte_nom, carte_image
    FROM P12_carte, P12_carteEdition
        WHERE P12_carte.num_carte = P12_carteEdition.num_carte AND carte_categorie ='Magie' AND num_edition = 1 ;
