/*
    Auteur : 	Groupe P12
    Description : 	Script de creation de la base de donnees YuGiOh mysql
 */
...
#creaton de la table edition
CREATE TABLE P12_edition (
   num_edition INT AUTO_INCREMENT PRIMARY KEY,
...
CREATE TABLE P12_carte (
    num_carte INT AUTO_INCREMENT PRIMARY KEY,
...
#creation de la table langue
CREATE TABLE P12_langue (
    num_langue INT AUTO_INCREMENT PRIMARY KEY,
    nom_langue VARCHAR(30) NOT NULL
);

#creation de la table carteEdition, asspciation entre carte et edition
...
#creaton de la table cartePossedee, cartes possedees par le collectionneur (quantite)
...
#creation de la table relation, table intermediaire regroupant les cartes et leurs relations
...
/*
  insertion des données dans la table relation, table intermediaire
  qui continet les données de toutes les cartes de toutes les éditions
*/
...
#création de la table temporaire pour la suppression des doublons dans la table carte
CREATE TEMPORARY TABLE TempTable AS
SELECT carte_nom, MAX(num_carte) AS max_num_carte
FROM P12_carte
GROUP BY carte_nom;
#suppression des doublons dans la table carte
DELETE FROM P12_carte
WHERE (carte_nom, num_carte) NOT IN (
    SELECT carte_nom, max_num_carte
    FROM TempTable
);
...
INSERT INTO P12_langue(nom_langue) VALUES('Anglais'),('Français'),('Allemand'),('Espagnol'),('Japonais');
